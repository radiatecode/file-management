...
Route::post("/rename/files","FileViewerController@renameFiles")->name('rename.files');
Route::post("/delete/files","FileViewerController@deleteFiles")->name('delete.files');
Route::get("/delete/file/{id}","FileViewerController@deleteFile");
